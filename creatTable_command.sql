...
(
        member_uid CHAR(20) PRIMARY KEY,
        member_name VARCHAR(20),
        admin_uid CHAR(20),
        admin_name VARCHAR(20),
        constraint G_muid_FU foreign key(member_uid) references ForumUser(uid),
        constraint G_mname_FU foreign key(member_name) references ForumUser(uname),
        constraint G_auid_FU foreign key(admin_uid) references ForumUser(uid),
        constraint G_aname_FU foreign key(admin_name) references ForumUser(uname)
);
